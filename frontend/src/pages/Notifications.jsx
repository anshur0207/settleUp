    ...
    <div className="bg-white rounded-2xl md:rounded-[28px] p-5 md:p-7 shadow-lg border border-gray-100 h-full">
      <div className="flex items-center justify-between gap-4">
        <div className="flex-1 min-w-0">
          ...
          <h2 className="text-2xl md:text-4xl font-black mt-1 md:mt-2 truncate text-gray-900">{value}</h2>
        </div>
        <div className="shrink-0 w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-3xl bg-emerald-100 flex items-center justify-center text-2xl md:text-3xl">
          {emoji}
        </div>
      </div>
    </div>
